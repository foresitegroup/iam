...
<div class="darkgray tour-section-title">
  <article>
    <span class="redtext">1.</span> MANAGE SINGLE OR MULTIPLE PORTFOLIOS
  </article>
</div>

<div class="tour-section-menu">
  <article>
    <a href="tour-iam-1-1.php" class="tour-section-link-prev"><i class="fa fa-angle-left"></i></a>
    <a href="tour-iam-1-1.php" class="tour-section-link">1.1</a>
    <hr class="tour-section-link-hr">
    <a href="tour-iam-1-2.php" class="tour-section-link current">1.2</a>
    <hr class="tour-section-link-hr">
