...
$result = $mysqli->query("SELECT email,firstname,lastname,address,city,state,zip,phone,serial_number,FROM_UNIXTIME(purch_date,'%c/%d/%Y'),FROM_UNIXTIME(support_renewal_date,'%c/%d/%Y'),renewal_code,qm_code FROM registration ORDER BY lastname ASC");
