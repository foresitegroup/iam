...
<article class="bluetext centered">
  Included are quick explanations of specific features and and functions in IAM for Individual users.
</article>

<hr class="full mb">

<article class="howto">
  <a href="how-to-batch-reporting.php">Batch Reporting</a><br>
  <br>

  <a href="how-to-changing-user-preferences.php">Changing User Preference</a><br>
  <br>
  ...
  <a href="how-to-current-asset-library.php">Current Asset Library</a><br>
  <br>

  <a href="how-to-fundamental-analysis-with-investment-account-manager.php">Fundamental Analysis with Investment Account Manager</a><br>
  <br>

  <a href="how-to-global-transactions.php">Global Transactions</a><br>
  <br>

  <a href="how-to-historic-price-library.php">Historic Price Library</a><br>
  <br>

  <a href="how-to-home-page.php">Home Page</a><br>
  <br>

  <a href="how-to-how-to-use-price-alerts-with-iam.php">How to Use Price Alerts With IAM</a><br>
  <br>
  ...
  <a href="how-to-reinstalling-investment-account-manager-on-a-second-computer.php">Reinstalling Investment Account Manager on a Second Computer</a><br>
  <br>

  <a href="how-to-tax-decision-making-with-investment-account-manager.php">Tax decision making with Investment Account Manager</a><br>
  <br>
