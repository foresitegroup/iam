...
<div class="tour-section-menu">
  <article>
    <a href="tour-iam-1-2.php" class="tour-section-link-prev"><i class="fa fa-angle-left"></i></a>
...
<div class="gray bt bb tour-content">
  <article>
    ...
    <img src="images/tour-iam-1-3.jpg" alt="">
...
<div class="tour-section-menu footer">
  <article>
    <a href="tour-iam-1-2.php" class="prev"><i class="fa fa-angle-left"></i> PREV 1.2</a>
    <a href="tour-iam.php" class="index"><i class="fa fa-list-ul"></i></a>
    <a href="tour-iam-1-4.php" class="next">NEXT 1.4 <i class="fa fa-angle-right"></i></a>
  </article>
</div>
